...
/* ── Trigger — looks exactly like input-glass ── */
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "group input-glass flex w-full items-center justify-between gap-2",
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Label
    ref={ref}
    className={cn(
      "px-2 py-1 text-xs font-semibold uppercase tracking-wider text-foreground/40",
      className,
    )}
    {...props}
  />
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    className={cn(
      ...
      "transition-colors",
      "focus:bg-foreground/10 data-highlighted:bg-foreground/10",
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Separator
    ref={ref}
    className={cn("my-1 h-px bg-foreground/8", className)}
    {...props}
  />
));
